...
assert.equal(currentFaNames.length, 133, '入口当前发出的 Font Awesome 图标名基线必须保持为 133 个');
...
assert.match(indexSource, /from '\.\/qianmu-icon-renderer\.js\?v=1\.47\.1';/, '图标渲染器 import 必须按发布版本破缓存');
...
console.log('v1.47.1 Phosphor icon boundary and coverage contract OK');
