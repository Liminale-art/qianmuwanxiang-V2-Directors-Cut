...
assert.match(indexSource, /from '\.\/qianmu-icon-renderer\.js\?v=1\.45\.5';/, '图标渲染器 import 必须按发布版本破缓存');
...
console.log('v1.45.5 Phosphor icon boundary and coverage contract OK');
