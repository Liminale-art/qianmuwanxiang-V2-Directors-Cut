...
assert.equal(currentFaNames.length, 133, 'the removed permanent notes entry must not leave a dead icon in the runtime baseline');
...
assert.match(indexSource, /from '\.\/qianmu-icon-renderer\.js\?v=1\.58\.3';/, '图标渲染器 import 必须按发布版本破缓存');
