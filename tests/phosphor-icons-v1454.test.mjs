...
assert.match(indexSource, /from '\.\/qianmu-icon-renderer\.js\?v=1\.50\.0';/, '图标渲染器 import 必须按发布版本破缓存');
...
console.log('v1.50.0 Phosphor icon boundary and coverage contract OK');
