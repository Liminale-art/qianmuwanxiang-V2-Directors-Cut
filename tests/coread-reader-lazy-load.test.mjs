...
assert.match(source, /readerCore:\s*\{[\s\S]*loadLocalChunk\('\.\/qianmu-reader\.js\?v=1\.59\.149'\)[\s\S]*reader = module/, 'the companion parser must load through the shared recoverable feature runtime');
