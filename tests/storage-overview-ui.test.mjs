...
function fixture(data = null, status = 'ready') {
  const context = vm.createContext({renderStorageBackupSection,storageOverviewSegments,VERSION:'1.59.390',STORAGE_CATEGORY_LABELS,STORAGE_CATEGORY_COLORS, storageInventoryState: { data, status, error: '<unavailable>' },
