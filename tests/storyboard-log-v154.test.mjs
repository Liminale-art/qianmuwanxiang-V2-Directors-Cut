...
assert.doesNotMatch(source, /sd-storyboard-log-head|data-storyboard-log-filter/, '日志不保留标题卡或状态筛选入口');
assert.match(source, /sd-storyboard-log-maintenance/, '收片、打包和手动管理仍可从折叠管理区访问');
