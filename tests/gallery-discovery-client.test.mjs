...
const response=()=>({ok:true,version:1,expectedAccount,entries:[],nextCursor:null,proof:'read-only-directory'});
...
test('client is lazy, chat-independent, same-origin, and only sends expected account and bounded pagination',async t=>{
  ...
  assert.deepEqual(JSON.parse(call.body),{version:1,expectedAccount,limit:24,cursor:null});
});
