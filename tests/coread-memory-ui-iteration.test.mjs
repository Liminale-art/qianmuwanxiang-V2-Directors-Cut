...
const inject = source.slice(source.indexOf('function renderMemInjectTab'), source.indexOf('function renderCompanionSetupBody'))
  + centerView.slice(centerView.indexOf('export function renderCoreadInjectionRowsView'));
...
assert.match(inject, /检索词典 <span class="sd-reader-inj-tag">\$\{dictPairCount\}<\/span><span class="sd-reader-inj-tag\$\{curBound/, '词典绑定状态必须紧跟词典数量同排显示');
