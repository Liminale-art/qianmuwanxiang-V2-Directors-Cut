...
async function fixture(t){
  ...
  const controller=createCharacterArchiveController({store,resolveNamespace:async()=>account,getContext:async()=>({chatKey:'test',subjects:[]}),notify:(text,kind)=>notices.push({text,kind})});
