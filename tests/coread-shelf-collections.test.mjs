...
assert.match(exportBlock, /const prefs = omitConfigConnections\(\{coread:coreadSanitizePackageValue\(reader\)\}\)\.coread[\s\S]*version: 5[\s\S]*prefs,/, 'v5伴读包从独立快照携带合集结构，并排除完整连接');
