...
assert.match(source, /routedConnection[\s\S]*model: String\(connection\?\.model \|\| baseProviderProfile\.model[\s\S]*storyboardGenerationPayload\(state, providerProfile/, '镜组路由必须使用连接预设的真实模型并按该模型裁剪能力');
