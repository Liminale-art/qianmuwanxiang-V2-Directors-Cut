...
function fixture(local){
  ...
  const c=vm.createContext({isPlainObject,clone,readCoreadPackageFile,coreadPackageSafeKey,omitConfigConnections,
    coread:()=>local,readerDialog:{loaded:false},toast:m=>notices.push(m),confirmDialog:async()=>true,
