...
assert.match(source, /const VERSION = '1\.59\.211';/);
assert.match(source, /historical-import-runtime\.js\?v=1\.59\.211/);
assert.match(source, /historical-restore-view\.js\?v=1\.59\.211/);
