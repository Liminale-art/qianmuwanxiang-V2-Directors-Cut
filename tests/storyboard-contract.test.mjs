...
assert.match(indexSource, /storyboardContract:[\s\S]*import\('\.\/qianmu-storyboard-contract\.js\?v=1\.58\.52'\)/, 'the contract validator must stay outside the startup graph');
