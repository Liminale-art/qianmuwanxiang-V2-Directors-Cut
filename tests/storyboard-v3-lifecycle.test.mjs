...
assert.deepEqual(normalizeStoryboardAutomation({ autoCapture: false, autoGenerate: true }), { autoGenerate: false, streamEnabled: false });
...
assert.deepEqual(upgraded.automation, { autoGenerate: false, streamEnabled: false });
