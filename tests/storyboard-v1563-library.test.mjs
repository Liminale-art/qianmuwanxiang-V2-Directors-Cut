...
assert.match(style, /\.sd-storyboard-root input\.text_pole:not\(\[type="file"\]\),[\s\S]*min-height: 42px !important; height: 42px/);
...
assert.match(source, /function storyboardRedrawRecord\(record, \{ artistPreset = undefined \} = \{\}\)/);
