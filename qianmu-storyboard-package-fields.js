...
export const STORYBOARD_ADDED_IMPORT_FIELDS=Object.freeze(['directorBridge','prompt','negative','contentRating','paragraphMode','promptDraft','lastModelSource','comfyPoolSelection','comfyAutoEnabled','comfyLibrarySelection','characterArchive','collapsedCards','tagSort','galleryKeywords']);
