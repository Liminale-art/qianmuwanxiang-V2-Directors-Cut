...
export function installTextCollectionRoutes(router,{dataRoot,register,serviceOptions={}}){
  let service;
  for(const action of ['list','get','snapshot','restore-info','inventory','write','write-batch','batch-info','cleanup-plan'])router.post(`/text-collections/${action}`,async(req,res)=>{
