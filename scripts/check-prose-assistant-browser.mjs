...
const allowed=new Set(['qianmu-prose-floor-tools.js','qianmu-text-collection-floor.js','qianmu-plain-text-range.js','qianmu-current-chat-source.js','qianmu-chat-file-target.js','qianmu-model-response.js','qianmu-llm-output.js','qianmu-portable-connection.js','qianmu-account-local-store.js',...['floor','panel','source','context','session','request','messages','preferences','history-contract','history','history-runtime'].map(name=>`qianmu-prose-assistant-${name}.js`)]);
