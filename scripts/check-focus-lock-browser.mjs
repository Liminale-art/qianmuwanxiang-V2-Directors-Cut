...
try{
  ...
  await page.evaluate(async({defaults,functions,guardSource,iconSource,profileSource})=>{
    ...
    Object.assign(window,await import('https://qianmu.test/qianmu-focus-events.js'));
    ...
    window.focusClockRuntime=null;window.focusClockVoiceCache=createFocusVoiceCache({available:()=>false,read:async()=>null});
