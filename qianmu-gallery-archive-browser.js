...
import {createGalleryArchiveStorage} from './qianmu-gallery-archive-storage.js?v=1.59.314';
...
import {createGalleryOriginalClient} from './qianmu-gallery-original-client.js?v=1.59.314';
import {decodeGalleryOriginalBlob} from './qianmu-gallery-original-preview.js';
import {createGalleryRestoreSource} from './qianmu-gallery-restore-source.js?v=1.59.314';
import {verifyGalleryRestoreOriginals} from './qianmu-gallery-restore-originals.js?v=1.59.314';
...
export function createGalleryArchiveBrowser({account,headers,isCurrent=()=>true,
  ...
  createRestoration=async options=>(await import('./qianmu-gallery-restore-execution.js?v=1.59.314')).createGalleryRestoreExecution(options),
  ...
  return Object.freeze({
    ...
    prepare({onProgress=()=>{}}={}){return run(async()=>{
      ...
      const {prepareCurrentGalleryRestore}=await import('./qianmu-gallery-restore-runtime.js?v=1.59.314');await check();
