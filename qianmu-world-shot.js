...
export {createWorldPromptAttempt} from './qianmu-world-prompt-diagnostics.js?v=1.59.349';
import {applyCharacterCasting,characterCastingInput} from './qianmu-character-casting.js';
import {normalizeStoryboardShotSpec} from './qianmu-storyboard.js?v=1.59.349';
...
export async function prepareWorldStyleSelection(state,inputGuard,dependencies,options){
  ...
  const runtime=await import('./qianmu-world-ensemble.js?v=1.59.349');inputGuard.assertCurrent();
