...
export function createFocusLibraryRuntime({resolveNamespace,owner,context,choices,generate,ui,notify,save}) {
  ...
  function warm(){return Promise.all([loadLocalChunk('./qianmu-focus-dialogue-ui.js?v=1.59.140'),loadLocalChunk('./qianmu-focus-dialogue.js?v=1.59.140')]);}
  ...
  async function open(options){
    ...
    try{
      ...
      const {openFocusLibrary}=await loadLocalChunk('./qianmu-focus-library-ui.js?v=1.59.140');await guard();
