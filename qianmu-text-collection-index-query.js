...
export async function queryIndexedCollection(state,method,input,{common,expectedAccount,now,readEntry,check,yieldWork=()=>new Promise(resolve=>setTimeout(resolve,0))}={}){
  ...
  const term=(input.search||'').trim().toLowerCase(),filtered=Object.hasOwn(input,'search')?{search:input.search.trim()}:{},rows=[];
