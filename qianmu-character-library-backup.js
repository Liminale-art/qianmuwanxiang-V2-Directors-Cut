...
export function planCharacterLibraryRestore(local, incoming, { decisions = {} } = {}) {
  ...
  const value = { ...local, archives: [...archives.values()], bindings: [...bindings.values()], usage: { count: archives.size, bytes: [...archives.values()].reduce((sum, row) => sum + row.head.bytes, 0), bindings: bindings.size } };
