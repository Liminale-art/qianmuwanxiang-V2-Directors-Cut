...
export const QIANMU_IDLE_CHUNKS=Object.freeze([
 './qianmu-prose-assistant-panel.js','./qianmu-prose-assistant-native.js?v=1.59.375',
 './qianmu-text-collection-library.js','./qianmu-character-archive-view.js?v=1.59.375',
 './qianmu-vibe-library-view.js?v=1.59.375','./qianmu-ensemble-ui.js?v=1.59.375',
 './qianmu-comfy-library-view.js?v=1.59.375','./qianmu-comfy-pool-view.js?v=1.59.375',
 './qianmu-comfy-route.js?v=1.59.375','./qianmu-text-collection-capture.js',
]);
