...
export const STORYBOARD_BUNDLE_LIMITS = Object.freeze({ total: 512 * 1048576, manifest: 1048576, entries: 1030,
  storyboard: 128 * 1048576, workflows: 80 * 1048576, pools: 24 * 1048576, characters: 24 * 1048576, 'legacy-vibes': 2 * 1048576, 'chat-evidence': 24 * 1048576, image: 16 * 1048576 });
...
const documents = [...fixed, 'legacy-vibes', 'chat-evidence'];
